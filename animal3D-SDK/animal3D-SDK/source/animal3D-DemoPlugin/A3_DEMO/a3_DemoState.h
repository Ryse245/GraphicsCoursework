	...
	struct a3_DemoState
	{
		...
		union {
			...
			struct {
				...
				a3_DemoStateShaderProgram
					prog_drawFractalPattern[1],					//draw a fractal pattern as a texture on objects
					prog_drawFractalNoise[1];					//draw fractal noise as a texture on objects
			};
		};
		...
		union {
			...
			struct {
				...
				a3_Framebuffer
					fbo_fractal[1];								//framebuffer for fractals
			};
		};
